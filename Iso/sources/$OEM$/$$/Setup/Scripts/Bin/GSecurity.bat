...
:: Unregister reg extension (no further importing of reg files possible)
reg delete "HKCR\.reg" /f
reg delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.reg" /f
